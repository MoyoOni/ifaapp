const ProfileSkeleton = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col sm:flex-row gap-6">
            <div className="flex-shrink-0 self-center sm:self-start">
              <div className="w-24 h-24 md:w-28 md:h-28 rounded-2xl bg-muted animate-pulse" />
            </div>
            <div className="flex-1 min-w-0 text-center sm:text-left space-y-3">
              <div className="h-6 bg-muted rounded w-3/4 mx-auto sm:mx-0 animate-pulse" />
              <div className="h-4 bg-muted/60 rounded w-1/2 mx-auto sm:mx-0 animate-pulse" />
              <div className="h-4 bg-muted/60 rounded w-4/5 mx-auto sm:mx-0 animate-pulse mt-2" />
          ...
          <div className="divide-y divide-border/50">
            <div className="p-5 flex items-start justify-between gap-4">
              ...
              <div className="text-right flex-shrink-0">
                ...
                <div className="h-6 bg-muted rounded w-12 mt-2 animate-pulse" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-2 bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/20 rounded-2xl shadow-sm overflow-hidden">
          <div className="p-6 flex items-center justify-between gap-4">
            <div className="space-y-2">
              ...
              <div className="h-4 bg-muted/60 rounded w-48 animate-pulse" />
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-2xl shadow-sm overflow-hidden">
            ...
            <div className="p-4 grid grid-cols-2 gap-2">
              <div className="h-8 bg-muted/60 rounded-lg animate-pulse" />
              <div className="h-8 bg-muted/60 rounded-lg animate-pulse" />
              <div className="h-8 bg-muted/60 rounded-lg animate-pulse" />
              <div className="h-8 bg-muted/60 rounded-lg animate-pulse" />
            </div>
          ...
          <div className="p-5">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-3 bg-muted/30 rounded-xl">
                ...
                <div className="h-3 bg-muted/60 rounded w-12 mx-auto mt-1 animate-pulse" />
              </div>
              <div className="text-center p-3 bg-muted/30 rounded-xl">
                <div className="h-6 bg-muted rounded w-8 mx-auto animate-pulse" />
                <div className="h-3 bg-muted/60 rounded w-12 mx-auto mt-1 animate-pulse" />
        ...
        <div className="md:col-span-3 bg-card border border-border rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              <div className="group flex items-center gap-3 p-3 bg-muted/30 border border-border rounded-xl">
                <div className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center flex-shrink-0 animate-pulse" />
                <div className="min-w-0">
                  <div className="h-4 bg-muted rounded w-24 animate-pulse" />
                  <div className="h-3 bg-muted/60 rounded w-16 mt-1 animate-pulse" />
                </div>
              </div>
              <div className="group flex items-center gap-3 p-3 bg-muted/30 border border-border rounded-xl">
                <div className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center flex-shrink-0 animate-pulse" />
      ...
      <div className="h-10 bg-muted rounded-xl w-24 animate-pulse" />
    </div>
  );
};
