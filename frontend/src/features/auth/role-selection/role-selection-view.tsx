...
const ROLE_OPTIONS: RoleOption[] = [
  {
    ...
    description: 'Find spiritual guidance, connect with verified Babalawos, and learn the Ifá tradition.',
    benefits: ['Browse verified Babalawos', 'Access cultural academy', 'Join sacred circles'],
    icon: <Search size={28} />,
  ...
  },
  {
    ...
    benefits: ['Build your verified profile', 'Manage your practice', 'Connect with temples'],
    icon: <Star size={28} />,
