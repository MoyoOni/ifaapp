  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-lg text-stone-700 dark:text-stone-300 font-bold text-sm hover:bg-muted/40 transition-colors"
      >
        <Calendar size={16} />
        Add to Calendar
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute top-full left-0 mt-2 w-48 bg-card rounded-lg shadow-lg border border-border z-20 overflow-hidden">
            <a
              href={googleUrl}
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => setIsOpen(false)}
              className="flex items-center gap-3 px-4 py-3 hover:bg-muted/40 transition-colors text-sm text-stone-700 dark:text-stone-300"
            >
            ...
            <button
              onClick={downloadICS}
              className="flex items-center gap-3 px-4 py-3 hover:bg-muted/40 transition-colors text-sm text-stone-700 dark:text-stone-300 w-full text-left"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsOpen(false)}
              className="flex items-center gap-3 px-4 py-3 hover:bg-muted/40 transition-colors text-sm text-stone-700 dark:text-stone-300 border-t border-border/50"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
